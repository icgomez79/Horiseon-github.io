...
### In HTML:
* Item 1 Added the following comments between sections to facilitate the code reading.
'<!--Navigation-->','<!--Unordered list-->','<!--List elements-->','<!--Anchor elements-->','<!--Hero section-->','<!--Benefits section-->','<!--Footer-->'.
* Item 2 Fixed the link for the '<a href="#search-engine-optimization">' changing the '<div class="search-engine-optimization" class="search-engine-optimization">' for '<div id="search-engine-optimization" class="search-engine-optimization">'.
* Item 3 Added the 'alt=' values for each image in the file to ensure accesibility.

### IN CSS:
* Item 1 Added the following comments between sections to facilitate the code reading.
'/*Apply styles to header*/', '/* Apply styles to hero*/','/*Apply styles to benefits*/','/*Apply styles to footer*/'.
* Item 2 **Consolidated this elements:**
'.benefit-lead {
    margin-bottom: 32px;
    color: #ffffff;
}
...
* Item 3 **Erasing this css elements:**
    '.benefit-lead h3 {
    margin-bottom: 10px;
    text-align: center;
    }'
...
* Item 4 **Consolidated these elements:**
'.benefit-lead img {
    display: block;
    margin: 10px auto;
    max-width: 150px;
...
* Item 5 **Changed the name of these elements:**
...
* Item 6 **Changed these elements that have the same style properties:**
...
* Item 7 Finally, in order to have a better classification and easy reading of the css code I moved the '.content' css element and '.content img' to the top of the file where all the other content elements were placed.
